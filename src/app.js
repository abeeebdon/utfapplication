...
store.dispatch(setServer({ protocol: "http", host: "localhost:8070", }));
store.dispatch(setApp({ name: "Universal-FX", namePlural: "Universal-FX's", version: "0.0.0", logo: "images/logo-nobg.png" }));
