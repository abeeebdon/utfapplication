...
import {
  selectGetOperatorsInCountryEndpoint, selectGetMobileRechargersEndpoint, selectGetCurrenciesEndpoint,
  selectGetPairHistoryEndpoint, selectGetDepositAddressEndpoint
} from '../state/selectors/endpoints';
...
export async function populateDepositAddress() {
  ...
  console.log('getDepositAddressURL', getDepositAddressURL);
